...
public enum MessageResource : int
{
    ...
    [Display(Name = "کاربر یافت نشد")] UserNotFound = 5,
    ...
    [Display(Name = "کاربر تکراری است")] UserIsDuplicate = 10,
    [Display(Name = "اطلاعات تکراری است")] DataIsDuplicate = 11,
    ...
    [Display(Name = "قرارداد یافت نشد")] ContractNotFound = 14,

    [Display(Name = "بیمه شده یافت نشد")] PersonageNotFound = 15,

    [Display(Name = "شما مجاز به این عملیات نمی باشید")]
    DontHaveAccess = 16,

    [Display(Name = "سقف موجود خسارت")] Overflow = 17,
    ...
    [Display(Name = "بانک یافت نشد")] BankNotFound = 23,
}