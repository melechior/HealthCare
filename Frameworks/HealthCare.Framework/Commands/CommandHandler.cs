namespace HealthCare.Framework.Commands
{
    public abstract class CommandHandler<TCommand> where TCommand : ICommand
    {
        ...
        //    _result.ResultMessages.Add(new ResultMessage(messageType: MessageType.Success, "")
        //    {
        //        MessageType = MessageType.Success,
        //        MeassageResource = MessageResource.Successed
        //    });
        ...
        //    _result.ResultMessages.Add(new ResultMessage()
        //    {
        //        MessageType = MessageType.Warning,
        //        MeassageResource = MessageResource.Failed
        //    });
        //}
        public abstract CommandResult Execute(TCommand command);
