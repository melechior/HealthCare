...
namespace HealthCare.Infrastructures.Data.SqlServer.Migrations
{
    ...
    [Migration("20250101205914_add_payment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthCare.Core.Domains.DamageFiles.Entities.Payment", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HealthCare.Core.Domains.DamageFiles.Entities.PaymentDamageFile", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("DamageFileDetailId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("DamageFileDetailId");

                    b.HasIndex("PaymentId");

                    b.ToTable("PaymentDamageFile");
                });
            ...
            modelBuilder.Entity("HealthCare.Core.Domains.Users.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("HealthCare.Core.Domains.DamageFiles.Entities.PaymentDamageFile", b =>
                {
                    b.HasOne("HealthCare.Core.Domains.DamagedFileDetails.DamageFileDetail", "DamageFileDetail")
                        .WithMany("PaymentDamageFiles")
                        .HasForeignKey("DamageFileDetailId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HealthCare.Core.Domains.DamageFiles.Entities.Payment", "Payment")
                        .WithMany("PaymentDamageFiles")
                        .HasForeignKey("PaymentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("DamageFileDetail");
            ...
            modelBuilder.Entity("HealthCare.Core.Domains.DamageFiles.Entities.Payment", b =>
                {
                    b.Navigation("PaymentDamageFiles");
                });
